...
// the superclass methods (as well as declare and implement new ones).
...
// and return type of an overridden method must be exactly the same as those of the method inherited
// from the supertype.
    ...
    public class MethodOverrideExplained {
